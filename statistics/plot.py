...
parser.add_argument('--input1', '-i1',nargs=1, default="pbd_primal_chebyshev_dual_residual.txt", type=str, required=False)
parser.add_argument('--input2', '-i2',nargs=1, default="pbd_dual_residual.txt", type=str, required=False)
...
ax.plot(x, dual_residual_use_cheb, label='pbd_primal_chebyshev')  # Plot some data on the axes.
ax.plot(x, dual_residual_no_cheb,  label='pbd_no_chebyshev')  # Plot more data on the axes...
ax.set_yscale("log")
...
# python plot.py -i1 pbd_no_chebyshev_dual_residual.txt -i2 pbd_primal_chebyshev_dual_residual.txt -i3 pbd_dual_chebyshev_dual_residual.txt -o no_primal_vs_dual_chebyshev.png